    ...
    if (data) {
        return (
            <div>
                ...
                />
                <div style={{ maxWidth: '93vw', overflow: 'auto', height: "78vh"}}>
                    <Table bordered hover variant="" size="sm">
                        <thead>
                        <tr className="">
                            {data.metadata.map((item) => (
                                <th style={{overflow: 'hidden', whiteSpace: "nowrap", textOverflow: "ellipsis"}} className="adminFontTable" key={item}>{item}</th>
                            ))}
                        </tr>
                        </thead>
                        <tbody>
                ...
                <div style={{border: "solid 1px #cccabf", marginTop: "auto"}}>
                    <PaginationMy
                        name={name}
                        data={data}
                        setData={setData}
